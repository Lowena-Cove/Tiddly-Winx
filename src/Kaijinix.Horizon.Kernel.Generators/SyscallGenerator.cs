...
namespace Kaijinix.Horizon.Kernel.Generators
{
    [Generator]
    class SyscallGenerator : ISourceGenerator
    {
        private const string ClassNamespace = "Kaijinix.HLE.HOS.Kernel.SupervisorCall";
        ...
        private const string NamespaceKernel = "Kaijinix.HLE.HOS.Kernel";
        private const string NamespaceHorizonCommon = "Kaijinix.Horizon.Common";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            generator.AppendLine("using Kaijinix.Common.Logging;");
            generator.AppendLine("using Kaijinix.Cpu;");
