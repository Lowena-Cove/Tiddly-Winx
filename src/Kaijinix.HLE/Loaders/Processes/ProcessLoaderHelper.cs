...
namespace Kaijinix.HLE.Loaders.Processes
{
    static class ProcessLoaderHelper
    {
        ...
        public static LibHac.Result EnsureSaveData(Switch device, ApplicationId applicationId, BlitStruct<ApplicationControlProperty> applicationControlProperty)
        {
            ...
            LibHac.Result resultCode = device.System.LibHacHorizonManager.KaijinixClient.Fs.EnsureApplicationCacheStorage(out _, out _, applicationId, in control);
            ...
            resultCode = device.System.LibHacHorizonManager.KaijinixClient.Fs.EnsureApplicationSaveData(out _, applicationId, in control, in userId);
            if (resultCode.IsFailure())
            {
