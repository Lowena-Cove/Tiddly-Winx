...
namespace Kaijinix.HLE.HOS.Applets.SoftwareKeyboard
{
    ...
    internal class SoftwareKeyboardRendererBase
    {
        ...
        private readonly SKBitmap _KaijinixLogo = null;
        ...
        {
            int KaijinixLogoSize = 32;

            string KaijinixIconPath = "Kaijinix.HLE.HOS.Applets.SoftwareKeyboard.Resources.Logo_Kaijinix.png";
            _KaijinixLogo = LoadResource(typeof(SoftwareKeyboardRendererBase).Assembly, KaijinixIconPath, KaijinixLogoSize, KaijinixLogoSize);

            string padAcceptIconPath = "Kaijinix.HLE.HOS.Applets.SoftwareKeyboard.Resources.Icon_BtnA.png";
            string padCancelIconPath = "Kaijinix.HLE.HOS.Applets.SoftwareKeyboard.Resources.Icon_BtnB.png";
            string keyModeIconPath = "Kaijinix.HLE.HOS.Applets.SoftwareKeyboard.Resources.Icon_KeyF6.png";
        ...
        private void DrawImmutableElements()
        {
            ...
            canvas.DrawBitmap(_KaijinixLogo, _logoPosition);
        ...
        private void ComputeConstants()
        {
            ...
            int logoPositionX = (totalWidth - _KaijinixLogo.Width) / 2;
