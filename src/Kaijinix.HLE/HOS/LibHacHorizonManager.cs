...
using Kaijinix.HLE.HOS.Services.Arp;
using System;
...
namespace Kaijinix.HLE.HOS
{
    public class LibHacHorizonManager
    {
        ...
        public HorizonClient KaijinixClient { get; private set; }
        ...
        private void InitializeServer()
        {
            ...
            KaijinixClient = Server.CreatePrivilegedHorizonClient();
        }

        public void InitializeArpServer()
        {
            _arpIReader.Reset(new LibHacIReader());
            KaijinixClient.Sm.RegisterService(new LibHacArpServiceObject(ref _arpIReader), "arp:r").ThrowIfFailure();
        }
