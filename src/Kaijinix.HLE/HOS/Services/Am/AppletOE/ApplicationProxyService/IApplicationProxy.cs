...
using Kaijinix.HLE.HOS.Services.Am.AppletOE.ApplicationProxyService.ApplicationProxy;

namespace Kaijinix.HLE.HOS.Services.Am.AppletOE.ApplicationProxyService
{
