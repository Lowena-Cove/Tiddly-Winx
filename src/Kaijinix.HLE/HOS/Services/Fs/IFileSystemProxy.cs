...
using Kaijinix.HLE.HOS.Services.Fs.FileSystemProxy;
using System;
using System.IO;
using static Kaijinix.HLE.Utilities.StringUtils;
...
#pragma warning restore IDE0059
        ...
        public ResultCode OutputAccessLogToSdCard(ServiceCtx context)
        {
            ...
            // FS ends each line with a newline. Remove it because Kaijinix logging adds its own newline
