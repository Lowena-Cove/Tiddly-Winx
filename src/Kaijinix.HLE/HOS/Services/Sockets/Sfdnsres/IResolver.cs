...
using Kaijinix.Cpu;
using Kaijinix.HLE.HOS.Services.Sockets.Nsd.Manager;
using Kaijinix.HLE.HOS.Services.Sockets.Sfdnsres.Proxy;
using Kaijinix.HLE.HOS.Services.Sockets.Sfdnsres.Types;
...
namespace Kaijinix.HLE.HOS.Services.Sockets.Sfdnsres
{
    [Service("sfdnsres")]
