...
using Kaijinix.HLE.HOS.Services.Hid.Types.SharedMemory;
using Kaijinix.HLE.HOS.Services.Hid.Types.SharedMemory.Common;
using Kaijinix.HLE.HOS.Services.Hid.Types.SharedMemory.DebugPad;
using Kaijinix.HLE.HOS.Services.Hid.Types.SharedMemory.Keyboard;
using Kaijinix.HLE.HOS.Services.Hid.Types.SharedMemory.Mouse;
using Kaijinix.HLE.HOS.Services.Hid.Types.SharedMemory.Npad;
using Kaijinix.HLE.HOS.Services.Hid.Types.SharedMemory.TouchScreen;
