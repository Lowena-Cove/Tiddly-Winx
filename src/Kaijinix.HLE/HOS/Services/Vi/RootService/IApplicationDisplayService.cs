...
using Kaijinix.HLE.HOS.Services.Vi.RootService.ApplicationDisplayService;
using Kaijinix.HLE.HOS.Services.Vi.RootService.ApplicationDisplayService.Types;
using Kaijinix.HLE.HOS.Services.Vi.Types;
...
namespace Kaijinix.HLE.HOS.Services.Vi.RootService
{
