...
using Kaijinix.HLE.HOS.Services.Nv.NvDrvServices;
using Kaijinix.HLE.HOS.Services.Nv.NvDrvServices.NvHostAsGpu;
using Kaijinix.HLE.HOS.Services.Nv.NvDrvServices.NvHostChannel;
using Kaijinix.HLE.HOS.Services.Nv.NvDrvServices.NvHostCtrl;
using Kaijinix.HLE.HOS.Services.Nv.NvDrvServices.NvHostCtrlGpu;
using Kaijinix.HLE.HOS.Services.Nv.NvDrvServices.NvHostDbgGpu;
using Kaijinix.HLE.HOS.Services.Nv.NvDrvServices.NvHostProfGpu;
using Kaijinix.HLE.HOS.Services.Nv.NvDrvServices.NvMap;
