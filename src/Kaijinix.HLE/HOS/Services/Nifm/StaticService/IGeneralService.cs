...
using Kaijinix.HLE.HOS.Services.Nifm.StaticService.GeneralService;
using Kaijinix.HLE.HOS.Services.Nifm.StaticService.Types;
using System;
using System.Net.NetworkInformation;
using System.Runtime.CompilerServices;

namespace Kaijinix.HLE.HOS.Services.Nifm.StaticService
{
    class IGeneralService : DisposableIpcService
    {
        ...
        public ResultCode GetCurrentNetworkProfile(ServiceCtx context)
        {
            ...
            "KaijinixNetwork"u8.CopyTo(networkProfile.Name.AsSpan());
