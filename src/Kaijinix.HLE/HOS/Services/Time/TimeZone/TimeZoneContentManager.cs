...
using System.IO;
using System.Text;
using TimeZoneRuleBox = Kaijinix.Common.Memory.Box<Kaijinix.HLE.HOS.Services.Time.TimeZone.TimeZoneRule>;
...
namespace Kaijinix.HLE.HOS.Services.Time.TimeZone
{
    public class TimeZoneContentManager
    {
        ...
        private const string TimeZoneSystemTitleMissingErrorMessage = "TimeZoneBinary system title not found! TimeZone conversions will not work, provide the system archive to fix this error. (See https://github.com/Kaijinix/Kaijinix/wiki/Kaijinix-Setup-&-Configuration-Guide#initial-setup-continued---installation-of-firmware for more information)";
