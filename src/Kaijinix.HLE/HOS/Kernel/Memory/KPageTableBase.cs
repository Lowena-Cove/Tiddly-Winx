...
namespace Kaijinix.HLE.HOS.Kernel.Memory
{
    abstract class KPageTableBase
    {
        ...
        /// <exception cref="Kaijinix.Memory.InvalidMemoryRegionException">Throw for unhandled invalid or unmapped memory accesses</exception>
