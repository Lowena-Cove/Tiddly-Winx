...
using CemuHookClient = Kaijinix.Input.Motion.CemuHook.Client;
using ControllerType = Kaijinix.Common.Configuration.Hid.ControllerType;
using PlayerIndex = Kaijinix.HLE.HOS.Services.Hid.PlayerIndex;
using Switch = Kaijinix.HLE.Switch;

namespace Kaijinix.Input.HLE
{
