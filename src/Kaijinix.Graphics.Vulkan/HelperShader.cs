...
using CompareOp = Kaijinix.Graphics.GAL.CompareOp;
using Format = Kaijinix.Graphics.GAL.Format;
using PrimitiveTopology = Kaijinix.Graphics.GAL.PrimitiveTopology;
using SamplerCreateInfo = Kaijinix.Graphics.GAL.SamplerCreateInfo;
using StencilOp = Kaijinix.Graphics.GAL.StencilOp;
using Viewport = Kaijinix.Graphics.GAL.Viewport;
using VkFormat = Silk.NET.Vulkan.Format;

namespace Kaijinix.Graphics.Vulkan
{
    enum ComponentType
    {
        Float,
    ...
    class HelperShader : IDisposable
    {
        ...
        private const string ShaderBinariesPath = "Kaijinix.Graphics.Vulkan/Shaders/SpirvBinaries";
