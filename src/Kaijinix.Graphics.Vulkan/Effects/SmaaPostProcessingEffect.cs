...
using System;
using Format = Kaijinix.Graphics.GAL.Format;
using SamplerCreateInfo = Kaijinix.Graphics.GAL.SamplerCreateInfo;

namespace Kaijinix.Graphics.Vulkan.Effects
{
    internal class SmaaPostProcessingEffect : IPostProcessingEffect
    {
        ...
        private void RecreateShaders(int width, int height)
        {
            ...
            var edgeShader = EmbeddedResources.Read("Kaijinix.Graphics.Vulkan/Effects/Shaders/SmaaEdge.spv");
            var blendShader = EmbeddedResources.Read("Kaijinix.Graphics.Vulkan/Effects/Shaders/SmaaBlend.spv");
            var neighbourShader = EmbeddedResources.Read("Kaijinix.Graphics.Vulkan/Effects/Shaders/SmaaNeighbour.spv");
        ...
        private void Initialize()
        {
            ...
            var areaTexture = EmbeddedResources.ReadFileToRentedMemory("Kaijinix.Graphics.Vulkan/Effects/Textures/SmaaAreaTexture.bin");
            var searchTexture = EmbeddedResources.ReadFileToRentedMemory("Kaijinix.Graphics.Vulkan/Effects/Textures/SmaaSearchTexture.bin");
