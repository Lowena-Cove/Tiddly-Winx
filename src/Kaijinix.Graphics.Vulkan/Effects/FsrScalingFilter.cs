...
using System;
using Extent2D = Kaijinix.Graphics.GAL.Extents2D;
...
namespace Kaijinix.Graphics.Vulkan.Effects
{
    internal class FsrScalingFilter : IScalingFilter
    {
        ...
        public void Initialize()
        {
            ...
            var scalingShader = EmbeddedResources.Read("Kaijinix.Graphics.Vulkan/Effects/Shaders/FsrScaling.spv");
            var sharpeningShader = EmbeddedResources.Read("Kaijinix.Graphics.Vulkan/Effects/Shaders/FsrSharpening.spv");
