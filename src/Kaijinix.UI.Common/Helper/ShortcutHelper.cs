...
namespace Kaijinix.UI.Common.Helper
{
    public static class ShortcutHelper
    {
        ...
        {
            string basePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Kaijinix.sh");
            var desktopFile = EmbeddedResources.ReadAllText("Kaijinix.UI.Common/shortcut-template.desktop");
            iconPath += ".png";
        ...
        {
            string basePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Kaijinix");
            var plistFile = EmbeddedResources.ReadAllText("Kaijinix.UI.Common/shortcut-template.plist");
            var shortcutScript = EmbeddedResources.ReadAllText("Kaijinix.UI.Common/shortcut-launch-script.sh");
            // Macos .App folder
        ...
        public static void CreateAppShortcut(string applicationFilePath, string applicationName, string applicationId, byte[] iconData)
        {
            ...
            {
                string iconPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), ".local", "share", "icons", "Kaijinix");
