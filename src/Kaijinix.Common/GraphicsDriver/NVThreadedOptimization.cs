using Kaijinix.Common.GraphicsDriver.NVAPI;
using System;
using System.Runtime.CompilerServices;
using System.Runtime.InteropServices;

namespace Kaijinix.Common.GraphicsDriver
{
    static partial class NVThreadedOptimization
    {
        private const string ProfileName = "Kaijinix Nvidia Profile";
        ...
        public static void SetThreadedOptimization(bool enabled)
        {
            ...
            if (status != 0)
            {
                ...
                application.AppName.Set("Kaijinix.exe");
                application.UserFriendlyName.Set("Kaijinix");
