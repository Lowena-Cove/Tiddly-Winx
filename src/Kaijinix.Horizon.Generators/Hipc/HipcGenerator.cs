...
namespace Kaijinix.Horizon.Generators.Hipc
{
    [Generator]
    class HipcGenerator : ISourceGenerator
    {
        ...
        private const string TypeResult = "Kaijinix.Horizon.Common.Result";
        private const string TypeBufferAttribute = "Kaijinix.Horizon.Sdk.Sf.BufferAttribute";
        private const string TypeCopyHandleAttribute = "Kaijinix.Horizon.Sdk.Sf.CopyHandleAttribute";
        private const string TypeMoveHandleAttribute = "Kaijinix.Horizon.Sdk.Sf.MoveHandleAttribute";
        private const string TypeClientProcessIdAttribute = "Kaijinix.Horizon.Sdk.Sf.ClientProcessIdAttribute";
        private const string TypeCommandAttribute = "Kaijinix.Horizon.Sdk.Sf." + CommandAttributeName;
        private const string TypeIServiceObject = "Kaijinix.Horizon.Sdk.Sf.IServiceObject";
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (var commandInterface in syntaxReceiver.CommandInterfaces)
            {
                ...
                generator.AppendLine("using Kaijinix.Horizon.Common;");
                generator.AppendLine("using Kaijinix.Horizon.Sdk.Sf;");
                generator.AppendLine("using Kaijinix.Horizon.Sdk.Sf.Cmif;");
                generator.AppendLine("using Kaijinix.Horizon.Sdk.Sf.Hipc;");
