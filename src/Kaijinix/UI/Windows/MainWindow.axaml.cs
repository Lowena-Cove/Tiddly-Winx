...
namespace Kaijinix.Ava.UI.Windows
{
    public partial class MainWindow : StyleableWindow
    {
        ...
        public MainWindow()
        {
            ...
            ViewModel.Title = $"Kaijinix {Program.Version}";
        ...
        private void Initialize()
        {
            ...
            VirtualFileSystem.FixExtraData(LibHacHorizonManager.KaijinixClient);

            AccountManager = new AccountManager(LibHacHorizonManager.KaijinixClient, CommandLineState.Profile);

            VirtualFileSystem.ReloadKeySet();

            ApplicationHelper.Initialize(VirtualFileSystem, AccountManager, LibHacHorizonManager.KaijinixClient);
        }
        ...
        private static async Task ShowVmMaxMapCountDialog()
        {
            ...
            UserResult response = await ContentDialogHelper.ShowTextDialog(
                $"Kaijinix - {LocaleManager.Instance[LocaleKeys.LinuxVmMaxMapCountDialogTitle]}",
