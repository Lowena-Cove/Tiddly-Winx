...
namespace Kaijinix.Ava.UI.Views.User
{
    public partial class UserEditorView : UserControl
    {
        private NavigationDialogHost _parent;
        private Models_UserProfile _profile;
            ...
            if (Program.PreviewerDetached)
            {
                switch (arg.NavigationMode)
                {
                    case NavigationMode.New:
                        var (parent, profile, isNewUser) = ((NavigationDialogHost parent, Models_UserProfile profile, bool isNewUser))arg.Parameter;
