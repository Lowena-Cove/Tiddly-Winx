...
using Kaijinix.Ava.UI.Models.Input;
...
namespace Kaijinix.Ava.UI.ViewModels.Input
{
    public class InputViewModel : BaseModel, IDisposable
    {
        private const string Disabled = "disabled";
        private const string ProControllerResource = "Kaijinix.UI.Common/Resources/Controller_ProCon.svg";
        private const string JoyConPairResource = "Kaijinix.UI.Common/Resources/Controller_JoyConPair.svg";
        private const string JoyConLeftResource = "Kaijinix.UI.Common/Resources/Controller_JoyConLeft.svg";
        private const string JoyConRightResource = "Kaijinix.UI.Common/Resources/Controller_JoyConRight.svg";
        ...
        private void LoadInputDriver()
        {
            ...
            {
                if (_mainWindow.InputManager.KeyboardDriver is this.AvaloniaKeyboardDriver)
                {
