...
namespace Kaijinix.Ava.UI.ViewModels
{
    public class SettingsViewModel : BaseModel
    {
        ...
        public bool IsScalingFilterActive => _scalingFilter == (int)Kaijinix.Common.Configuration.ScalingFilter.Fsr;
        ...
        internal AvaloniaList<Models_TimeZone> TimeZones { get; set; }
        ...
        public SettingsViewModel()
        {
            ...
            TimeZones = new AvaloniaList<Models_TimeZone>();
        ...
        public async Task LoadTimeZones()
        {
            ...
            foreach ((int offset, string location, string abbr) in _timeZoneContentManager.ParseTzOffsets())
            {
                ...
                await Dispatcher.UIThread.InvokeAsync(() =>
                {
                    TimeZones.Add(new Models_TimeZone($"UTC{hours:+0#;-0#;+00}:{minutes:D2}", location, abbr2));
