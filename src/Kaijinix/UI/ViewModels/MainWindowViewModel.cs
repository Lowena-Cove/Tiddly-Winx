...
using Kaijinix.Ava.UI.Controls;
using Kaijinix.Ava.UI.Helpers;
using Kaijinix.Ava.UI.Models;
using Kaijinix.Ava.UI.Models.Generic;
...
#pragma warning restore IDE0055
                    ...
                    Thread thread = new(() =>
                    {
                        ...
                        try
                        {
                            ...
                            Dispatcher.UIThread.InvokeAsync(async delegate
                            {
                                ...
                                await ContentDialogHelper.CreateInfoDialog(dialogTitle, message, LocaleManager.Instance[LocaleKeys.InputDialogOk], "", LocaleManager.Instance[LocaleKeys.KaijinixInfo]);
            ...
            var result = await StorageProvider.OpenFilePickerAsync(new FilePickerOpenOptions
            {
                ...
                FileTypeFilter = new List<FilePickerFileType>
                {
                    new(LocaleManager.Instance[LocaleKeys.FileDialogAllTypes])
                    {
                        ...
                        AppleUniformTypeIdentifiers = new[] { "com.Kaijinix.xci", "public.zip-archive" },
                        MimeTypes = new[] { "application/x-nx-xci", "application/zip" },
                    },
                    new("XCI")
                    {
                        Patterns = new[] { "*.xci" },
                        AppleUniformTypeIdentifiers = new[] { "com.Kaijinix.xci" },
        ...
        public void OpenKaijinixFolder()
        {
        ...
        {
            await NavigationDialogHost.Show(AccountManager, ContentManager, VirtualFileSystem, LibHacHorizonManager.KaijinixClient);
        }
        ...
        public async Task OpenFile()
        {
            var result = await StorageProvider.OpenFilePickerAsync(new FilePickerOpenOptions
            {
                ...
                FileTypeFilter = new List<FilePickerFileType>
                {
                    ...
                    {
                        Patterns = new[] { "*.nsp" },
                        AppleUniformTypeIdentifiers = new[] { "com.Kaijinix.nsp" },
                    ...
                    {
                        Patterns = new[] { "*.nca" },
                        AppleUniformTypeIdentifiers = new[] { "com.Kaijinix.nca" },
                        MimeTypes = new[] { "application/x-nx-nca" },
                    },
                    new("NRO")
                    {
                        Patterns = new[] { "*.nro" },
                        AppleUniformTypeIdentifiers = new[] { "com.Kaijinix.nro" },
                        MimeTypes = new[] { "application/x-nx-nro" },
                    },
                    new("NSO")
                    {
                        Patterns = new[] { "*.nso" },
                        AppleUniformTypeIdentifiers = new[] { "com.Kaijinix.nso" },
