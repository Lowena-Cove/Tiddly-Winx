...
namespace Kaijinix.Ava.UI.Renderer
{
    public class EmbeddedWindow : NativeControlHost
    {
        ...
        IPlatformHandle CreateWin32(IPlatformHandle control)
        {
            ...
            _wndProcDelegate = delegate (IntPtr hWnd, Win32NativeInterop.WindowsMessages msg, IntPtr wParam, IntPtr lParam)
            {
                switch (msg)
                {
                    case Win32NativeInterop.WindowsMessages.NcHitTest:
                        return -1;
                }
            ...
            Win32NativeInterop.WndClassEx wndClassEx = new()
            {
                cbSize = Marshal.SizeOf<Win32NativeInterop.WndClassEx>(),
                hInstance = GetModuleHandle(null),
                lpfnWndProc = Marshal.GetFunctionPointerForDelegate(_wndProcDelegate),
                style = Win32NativeInterop.ClassStyles.CsOwndc,
            ...
            WindowHandle = CreateWindowEx(0, _className, "NativeWindow", Win32NativeInterop.WindowStyles.WsChild, 0, 0, 640, 480, control.Handle, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero);
