...
namespace Kaijinix.Ava.UI.Applet
{
    internal partial class ControllerAppletDialog : UserControl
    {
        private const string ProControllerResource = "Kaijinix/Assets/Icons/Controller_ProCon.svg";
        private const string JoyConPairResource = "Kaijinix/Assets/Icons/Controller_JoyConPair.svg";
        private const string JoyConLeftResource = "Kaijinix/Assets/Icons/Controller_JoyConLeft.svg";
        private const string JoyConRightResource = "Kaijinix/Assets/Icons/Controller_JoyConRight.svg";
