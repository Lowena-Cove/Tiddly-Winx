using Kaijinix.Graphics.Shader.CodeGen;
using Kaijinix.Graphics.Shader.CodeGen.Glsl;
using Kaijinix.Graphics.Shader.CodeGen.Spirv;
...
using Kaijinix.Graphics.Shader.Translation.Optimizations;
using Kaijinix.Graphics.Shader.Translation.Transforms;
using System;
using System.Collections.Generic;
using System.Numerics;
using static Kaijinix.Graphics.Shader.IntermediateRepresentation.OperandHelper;
using static Kaijinix.Graphics.Shader.Translation.Translator;
