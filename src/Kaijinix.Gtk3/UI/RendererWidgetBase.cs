...
using ScalingFilter = Kaijinix.Graphics.GAL.ScalingFilter;
...
namespace Kaijinix.UI
{
    public abstract class RendererWidgetBase : DrawingArea
    {
        ...
        private void UpdateScalingFilter(object sender, ReactiveEventArgs<Kaijinix.Common.Configuration.ScalingFilter> e)
        {
            Renderer.Window.SetScalingFilter((ScalingFilter)ConfigurationState.Instance.Graphics.ScalingFilter.Value);
            Renderer.Window.SetScalingFilterLevel(ConfigurationState.Instance.Graphics.ScalingFilterLevel.Value);
        }
        ...
        private void UpdateAnriAliasing(object sender, ReactiveEventArgs<Kaijinix.Common.Configuration.AntiAliasing> e)
        {
                ...
                Task.Run(() =>
                {
                    lock (this)
                    {
                        ...
                        string directory = AppDataManager.Mode switch
                        {
                            ...
                            _ => System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyPictures), "Kaijinix"),
                        };
