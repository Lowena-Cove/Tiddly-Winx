...
#pragma warning restore CS0649, IDE0044
        ...
        public SettingsWindow(MainWindow parent, VirtualFileSystem virtualFileSystem, ContentManager contentManager) : this(parent, new Builder("Kaijinix.Gtk3.UI.Windows.SettingsWindow.glade"), virtualFileSystem, contentManager) { }
        ...
        private SettingsWindow(MainWindow parent, Builder builder, VirtualFileSystem virtualFileSystem, ContentManager contentManager) : base(builder.GetRawOwnedObject("_settingsWin"))
        {
            ...
            _galThreading.Changed += (sender, args) =>
            {
                ...
                {
                    GtkDialog.CreateInfoDialog("Warning - Backend Threading", "Kaijinix must be restarted after changing this option for it to apply fully. Depending on your platform, you may need to manually disable your driver's own multithreading when using Kaijinix's.");
                }
            };
