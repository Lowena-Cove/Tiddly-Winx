...
using Kaijinix.UI.Common.Models.Amiibo;
...
namespace Kaijinix.UI.Windows
{
    public partial class AmiiboWindow : Window
    {
        ...
        public AmiiboWindow() : base($"Kaijinix {Program.Version} - Amiibo")
        {
            Icon = new Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "Kaijinix.UI.Common.Resources.Logo_Kaijinix.png");
            ...
            _amiiboLogoBytes = EmbeddedResources.Read("Kaijinix.UI.Common/Resources/Logo_Amiibo.png");
        ...
        private async Task<bool> NeedsUpdate(DateTime oldLastModified)
        {
            try
            {
                HttpResponseMessage response = await _httpClient.SendAsync(new HttpRequestMessage(HttpMethod.Head, "https://amiibo.Kaijinix.org/"));
        ...
        private async Task<string> DownloadAmiiboJson()
        {
            try
            {
                HttpResponseMessage response = await _httpClient.GetAsync("https://amiibo.Kaijinix.org/");
