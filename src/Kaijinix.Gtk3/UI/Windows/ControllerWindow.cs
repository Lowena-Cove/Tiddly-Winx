...
using Button = Kaijinix.Input.Button;
using ConfigGamepadInputId = Kaijinix.Common.Configuration.Hid.Controller.GamepadInputId;
using ConfigStickInputId = Kaijinix.Common.Configuration.Hid.Controller.StickInputId;
using GUI = Gtk.Builder.ObjectAttribute;
using Key = Kaijinix.Common.Configuration.Hid.Key;
...
#pragma warning restore CS0649, IDE0044
        ...
        public ControllerWindow(MainWindow mainWindow, PlayerIndex controllerId) : this(mainWindow, new Builder("Kaijinix.Gtk3.UI.Windows.ControllerWindow.glade"), controllerId) { }
        ...
        private ControllerWindow(MainWindow mainWindow, Builder builder, PlayerIndex controllerId) : base(builder.GetRawOwnedObject("_controllerWin"))
        {
            ...
            Title = $"Kaijinix - Controller Settings - {_playerIndex}";
        ...
        private void SetControllerSpecificFields()
        {
            ...
            if (!OperatingSystem.IsMacOS())
            {
                ...
                {
                    "ProController" => new Gdk.Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "Kaijinix.UI.Common.Resources.Controller_ProCon.svg", 400, 400),
                    "JoyconLeft" => new Gdk.Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "Kaijinix.UI.Common.Resources.Controller_JoyConLeft.svg", 400, 500),
                    "JoyconRight" => new Gdk.Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "Kaijinix.UI.Common.Resources.Controller_JoyConRight.svg", 400, 500),
                    _ => new Gdk.Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "Kaijinix.UI.Common.Resources.Controller_JoyConPair.svg", 400, 500),
                };
            }
        }
        ...
        private void HandleButtonPressed(ToggleButton button, bool forStick)
        {
            ...
            Thread inputThread = new(() =>
            {
                ...
                while (true)
                {
                    ...
                    if (_mousePressed || keyboard.IsPressed(Kaijinix.Input.Key.Escape) || assigner.IsAnyButtonPressed() || assigner.ShouldCancel())
                    {
                        break;
                    }
                }
