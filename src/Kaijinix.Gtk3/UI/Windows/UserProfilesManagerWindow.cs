...
namespace Kaijinix.UI.Windows
{
    public partial class UserProfilesManagerWindow : Window
    {
        ...
        public UserProfilesManagerWindow(AccountManager accountManager, ContentManager contentManager, VirtualFileSystem virtualFileSystem) : base($"Kaijinix {Program.Version} - Manage User Profiles")
        {
