...
namespace Kaijinix.UI.Widgets
{
    internal class GtkDialog : MessageDialog
    {
        ...
        {
            new GtkDialog("Kaijinix - Info", mainText, secondaryText, MessageType.Info).Run();
        }

        internal static void CreateUpdaterInfoDialog(string mainText, string secondaryText)
        {
            new GtkDialog("Kaijinix - Updater", mainText, secondaryText, MessageType.Info).Run();
        }

        internal static MessageDialog CreateWaitingDialog(string mainText, string secondaryText)
        {
            return new GtkDialog("Kaijinix - Waiting", mainText, secondaryText, MessageType.Info, ButtonsType.None);
        }

        internal static void CreateWarningDialog(string mainText, string secondaryText)
        {
            new GtkDialog("Kaijinix - Warning", mainText, secondaryText, MessageType.Warning).Run();
        }
        ...
        internal static void CreateErrorDialog(string errorMessage)
        {
            ...
            new GtkDialog("Kaijinix - Error", "Kaijinix has encountered an error", errorMessage, MessageType.Error).Run();
        }

        internal static MessageDialog CreateConfirmationDialog(string mainText, string secondaryText = "")
        {
            return new GtkDialog("Kaijinix - Confirmation", mainText, secondaryText, MessageType.Question, ButtonsType.YesNo);
        }
        ...
        {
            return CreateChoiceDialog("Kaijinix - Exit", "Are you sure you want to close Kaijinix?", "All unsaved data will be lost!");
        }
    }
}
