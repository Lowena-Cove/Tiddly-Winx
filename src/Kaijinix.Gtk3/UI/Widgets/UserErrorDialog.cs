...
namespace Kaijinix.UI.Widgets
{
    ...
    {
        private const string SetupGuideUrl = "https://github.com/Kaijinix/Kaijinix/wiki/Kaijinix-Setup-&-Configuration-Guide";
        ...
        private UserErrorDialog(UserError error) : base(null, DialogFlags.Modal, MessageType.Error, ButtonsType.None, null)
        {
            ...
            Title = $"Kaijinix error ({errorCode})";
        ...
        private static string GetErrorDescription(UserError error)
        {
            return error switch
            {
                UserError.NoKeys => "Kaijinix was unable to find your 'prod.keys' file",
                UserError.NoFirmware => "Kaijinix was unable to find any firmwares installed",
                UserError.FirmwareParsingFailed => "Kaijinix was unable to parse the provided firmware. This is usually caused by outdated keys.",
                UserError.ApplicationNotFound => "Kaijinix couldn't find a valid application at the given path.",
