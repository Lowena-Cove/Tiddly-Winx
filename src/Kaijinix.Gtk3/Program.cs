...
using Kaijinix.UI.Common.SystemInfo;
...
namespace Kaijinix
{
    partial class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                MessageBoxA(IntPtr.Zero, "You are running an outdated version of Windows.\n\nKaijinix supports Windows 10 version 1803 and newer.\n", $"Kaijinix {Version}", MbIconWarning);
            }
            ...
            Console.Title = $"Kaijinix Console {Version}";
                ...
                if (LinuxHelper.VmMaxMapCount < LinuxHelper.RecommendedVmMaxMapCount)
                {
                    ...
                    if (LinuxHelper.PkExecPath is not null)
                    {
                        ...
                        ResponseType response = GtkDialog.CreateCustomDialog(
                            "Kaijinix - Low limit for memory mappings detected",
                            ...
                            "Kaijinix will crash as soon as this limit gets exceeded.",
                            buttonTexts,
                    ...
                    else
                    {
                        GtkDialog.CreateWarningDialog(
                            ...
                            "Some games might try to create more memory mappings than currently allowed. " +
                            "Kaijinix will crash as soon as this limit gets exceeded.\n\n" +
                            "You might want to either manually increase the limit or install pkexec, which allows Kaijinix to assist with that.");
                    }
                }
            }
        ...
        {
            Logger.Notice.Print(LogClass.Application, $"Kaijinix Version: {Version}");
