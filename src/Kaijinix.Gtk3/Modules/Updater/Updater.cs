...
using Kaijinix.UI;
using Kaijinix.UI.Common.Models.Github;
...
namespace Kaijinix.Modules
{
    public static class Updater
    {
        ...
        private static readonly string _updateDir = Path.Combine(Path.GetTempPath(), "Kaijinix", "update");
        ...
        private static HttpClient ConstructHttpClient()
        {
            ...
            result.DefaultRequestHeaders.Add("User-Agent", "Kaijinix-Updater/1.0.0");
        ...
        public static async Task BeginParse(MainWindow mainWindow, bool showVersionUpToDate)
        {
            ...
            {
                GtkDialog.CreateWarningDialog("Failed to convert the current Kaijinix version.", "Cancelling Update!");
                Logger.Error?.Print(LogClass.Application, "Failed to convert the current Kaijinix version!");
            ...
            try
            {
                ...
                {
                    if (asset.Name.StartsWith("gtk-Kaijinix") && asset.Name.EndsWith(_platformExt))
                    {
                        ...
                        if (asset.State != "uploaded")
                        {
                            ...
                            {
                                GtkDialog.CreateUpdaterInfoDialog("You are already using the latest version of Kaijinix!", "");
                            }
            ...
            {
                GtkDialog.CreateWarningDialog("Failed to convert the received Kaijinix version from GitHub Release.", "Cancelling Update!");
                Logger.Error?.Print(LogClass.Application, "Failed to convert the received Kaijinix version from GitHub Release!");
        ...
        public static void UpdateKaijinix(UpdateDialog updateDialog, string downloadUrl)
        {
...
#pragma warning restore SYSLIB0014
        ...
        private static async void InstallUpdate(UpdateDialog updateDialog, string updateFile)
        {
            ...
            updateDialog.SecondaryText.Text = "Do you want to restart Kaijinix now?";
        ...
        public static bool CanUpdate(bool showWarnings)
        {
            ...
            if (Program.Version.Contains("dirty") || !ReleaseInformation.IsValid)
            {
                if (showWarnings)
                {
                    GtkDialog.CreateWarningDialog("You cannot update a Dirty build of Kaijinix!", "Please download Kaijinix at https://Kaijinix.org/ if you are looking for a supported version.");
                }
            ...
            if (showWarnings)
            {
                ...
                {
                    GtkDialog.CreateWarningDialog("Updater Disabled!", "Please update Kaijinix via FlatHub.");
                }
                else
                {
                    GtkDialog.CreateWarningDialog("Updater Disabled!", "Please download Kaijinix at https://Kaijinix.org/ if you are looking for a supported version.");
                }
            }
