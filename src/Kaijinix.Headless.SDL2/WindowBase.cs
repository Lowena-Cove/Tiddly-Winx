...
using Kaijinix.HLE.HOS.Applets;
using Kaijinix.HLE.HOS.Services.Am.AppletOE.ApplicationProxyService.ApplicationProxy.Types;
...
namespace Kaijinix.Headless.SDL2
{
    abstract partial class WindowBase : IHostUIHandler, IDisposable
    {
        ...
        {
            Stream iconStream = typeof(WindowBase).Assembly.GetManifestResourceStream("Kaijinix.Headless.SDL2.Kaijinix.bmp");
        ...
        private void InitializeWindow()
        {
            ...
            WindowHandle = SDL_CreateWindow($"Kaijinix {Program.Version}{titleNameSection}{titleVersionSection}{titleIdSection}{titleArchSection}", SDL_WINDOWPOS_CENTERED_DISPLAY(DisplayId), SDL_WINDOWPOS_CENTERED_DISPLAY(DisplayId), Width, Height, DefaultFlags | FullscreenFlag | GetWindowFlags());
