...
using Kaijinix.Common.GraphicsDriver;
using Kaijinix.Common.Logging;
using Kaijinix.Common.Logging.Targets;
...
using Kaijinix.Graphics.Gpu;
using Kaijinix.Graphics.Gpu.Shader;
using Kaijinix.Graphics.OpenGL;
using Kaijinix.Graphics.Vulkan;
using Kaijinix.Graphics.Vulkan.MoltenVK;
using Kaijinix.Headless.SDL2.OpenGL;
using Kaijinix.Headless.SDL2.Vulkan;
using Kaijinix.HLE;
...
namespace Kaijinix.Headless.SDL2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.Title = $"Kaijinix Console {Version} (Headless SDL2)";
        ...
        static void Load(Options option)
        {
            ...
            _accountManager = new AccountManager(_libHacHorizonManager.KaijinixClient, option.UserProfile);
            ...
            if (!option.DisableFileLog)
            {
                ...
                {
                    Logger.Error?.Print(LogClass.Application, "No writable log directory available. Make sure either the Logs directory, Application Data, or the Kaijinix directory is writable.");
                }
            }
