...
namespace Kaijinix.Headless.SDL2.OpenGL
{
    class OpenGLWindow : WindowBase
    {
        ...
        private class SDL2OpenGLContext : IOpenGLContext
        {
            ...
            public static SDL2OpenGLContext CreateBackgroundContext(SDL2OpenGLContext sharedContext)
            {
                ...
                IntPtr windowHandle = SDL_CreateWindow("Kaijinix background context window", 0, 0, 1, 1, SDL_WindowFlags.SDL_WINDOW_OPENGL | SDL_WindowFlags.SDL_WINDOW_HIDDEN);
