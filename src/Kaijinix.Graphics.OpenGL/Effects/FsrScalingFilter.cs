...
using System;
using static Kaijinix.Graphics.OpenGL.Effects.ShaderHelper;
...
namespace Kaijinix.Graphics.OpenGL.Effects
{
    internal class FsrScalingFilter : IScalingFilter
    {
        ...
        {
            var scalingShader = EmbeddedResources.ReadAllText("Kaijinix.Graphics.OpenGL/Effects/Shaders/fsr_scaling.glsl");
            var sharpeningShader = EmbeddedResources.ReadAllText("Kaijinix.Graphics.OpenGL/Effects/Shaders/fsr_sharpening.glsl");
            var fsrA = EmbeddedResources.ReadAllText("Kaijinix.Graphics.OpenGL/Effects/Shaders/ffx_a.h");
            var fsr1 = EmbeddedResources.ReadAllText("Kaijinix.Graphics.OpenGL/Effects/Shaders/ffx_fsr1.h");
